...
for (let translationId of [
  ...
  'cobaltInstanceInfo',
  'cobaltInstanceLabel',
  'cobaltShareMenuItemInfo',
  'cobaltShareMenuItemLabel',
  'customCssLabel',
  'darkModeThemeLabel',
  'debugInfo',
  'debugLabel',
...
function exportConfig() {
  ...
  $a.download = 'control-panel-for-twitter-v4.25.0.config.txt'
